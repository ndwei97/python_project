# Milestone 4
# Date Created: 05/5/2017
# Date Last Modified: 05/7/2017
...
# All of the infromation is being pulled from the requests library.
# All pages have inventor hyperlinks.
						...
						for output_i in output:
							...
							for i in output_i:
								...
								if titleHeading == 1:
									...
									# make hyper links for each inventor in the list
